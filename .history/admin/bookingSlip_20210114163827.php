                        ...
                        <div class="card-body">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Name</td>
                                                <td></td>
                                                <td><?php echo $row['bFirstName'] . ' ' . $row['bLastName'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>Seat</td>
                                                <td></td>
                                                <td><?php echo $row['bselectSeat'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>Amount</td>
                                                <td></td>
                                                <td> N<?php// echo $row['trip_cost'] ?></td>
                                            </tr>
                                            <tr>
                                                <td>Email</td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td>Phone Number</td>
                                                <td></td>
                                                <td><?php echo $row['bPhoneNumber'] ?></td>
                                            </tr>
                                            <tr>
                            ...
                            <form id='payform' method='POST' action='https://voguepay.com/pay/'>
                                ...
                                <input type="hidden" name='success_url' value='http://localhost/Transport_Project/admin/successURL.php' />
                                    ...
                                    <input type='hidden' name='shipping' value=' N<?php echo $row['trip_cost'] ?>' />     
