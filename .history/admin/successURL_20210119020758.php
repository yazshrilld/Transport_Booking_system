...
<body  class="login-img3-body">
        ...
        if(!empty($get)) {
            ...
            //die();
                ...
                if($transaction[merchant_ref]=='234-567-890'){
                    echo "Getting There";
                    //die();
                    $bookingID = $_SESSION['ViewBooking'];
                    $select_ID_query = "SELECT * FROM `bookings` WHERE bookingsID = '$bookingID'";
