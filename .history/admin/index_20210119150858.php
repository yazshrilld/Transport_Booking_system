  ...
  <section id="hero">
    <div class="hero-container">
	  ...
	  <form class="booking-form-box" method="POST" action="booking_1.php">
		  ...
		  <div class="radio-btn">
      <button class="btn btn-primary" type="submit" name="roundTrip">Round Trip</button>
      <button class="btn btn-info" type="submit" name="oneWay">One Way</button>
      <button class="btn btn-warning" type="submit" name="multiWay">Multi Trip</button>
		  </div>
