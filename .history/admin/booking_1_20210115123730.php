<?php
   ...
   $username=$_SESSION['login_user'];
    ...
    $query= "SELECT `trip_title`,trip_cost,trip_dst,trip_state  FROM `trips` INNER JOIN `origin` ON  trips.trip_origin_id = origin.origin_id WHERE trip_id='$to'";
...
<body  class="login-img3-body"> 
	 ...
	 <div class="col-md-3"></div>
        <div class="col-6"><br />
		<form class="booking-form-box" id="form1" method="POST" action="booking_1.php">
		...
		//die();
					
					{
						?>
							<tr>
								<td style="color:white;"> <?php echo $row['trip_title'] ?> </td>
								<td style="color:white;"> N<?php echo $row['trip_cost'] ?> </td>
								<td style="color:white;"> <?php echo $row['trip_dst'] ?> </td>
								<td style="color:white;"> <?php echo $row['trip_state'] ?> </td>
							</tr>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form method="POST" action="" id="form-data">
							...
							<div class="form-group">
							<input type="hidden" name="amount" class="form-control" value="<?php echo $row['trip_cost']; ?>";>
							</div>
							<div class="form-group">
