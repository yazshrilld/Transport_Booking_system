  ...
  <section id="hero">
    <div class="hero-container">
	  ...
	  <form class="booking-form-box" method="POST" action="booking_1.php">
          ...
          <input type="submit" class="btn btn-primary" name="roundTrip" checked="checked" value="Round Trip">
          <input type="submit" class="btn btn-info" name="oneWay" value="One Way">
          <input type="submit" class="btn btn-warning" name="multiWay" value="Multi Trip">
		    </div>
