		    ...
		    <div class="booking-form">
			    ...
			    <select name="state_from" class="form-control origin">
			        ...
			        <div class="input-grp">
						...
						<input type="date" name="date_depart" id="date_departure" class="form-control select-date">
						<input type="date" name="date_arrive" id="date_arrival"><br>
						<input type="submit" name="submit" value="Post Date">
		            </div>
			        <div class="input-grp">
			            <label>Arrival</label>
						<input type="date" class="form-control select-date">
						<input type="date" name="date_depart" id="date_departure">
						<input type="date" name="date_arrive" id="date_arrival" class="form-control select-date"><br>
						<input type="submit" name="submit" value="Post Date">
		            </div>
