  ...
  <section id="hero">
    <div class="hero-container">
	  ...
	  <form class="booking-form-box" method="POST" action="booking_1.php">
		  ...
		  <div class="radio-btn">
			<input type="submit" class="btn btn-primary" name="roundTrip" checked="checked"><span> RoundTrip</span>
			<input type="submit" class="btn btn-info" name="oneWay"><span> OneWay</span>
			<input type="submit" class="btn btn-warning" name="multiWay"><span> MultiWay</span>
		  </div>
      ...
      <input type="hidden" value='view' name='action' class="form-control">
		  ...
		  <div class="input-grp">
		  <br>
		  <input type="submit" value="Quick Book" class="btn btn-danger">
