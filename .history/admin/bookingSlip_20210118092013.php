                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <div class="col-12">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr class="bg-info"><td>BookinID</td><td></td><td><?php echo $row[2] ?></td></tr>
                                        </thead>
                                        <tbody>
                            ...
                            <form id='payform' method='POST' action='https://voguepay.com/pay/'>
                                ...
                                <input type="hidden" name='success_url' value='http://localhost/Transport_Project/admin/successURL.php' />
                                    ...
                                    <input type='hidden' name='bFname' value='<?php echo $row[3] ?>' />
                                    <input type='hidden' name='bEmail' value='<?php echo $row[6] ?>' />
                                    <input type='hidden' name='bPhone' value='<?php echo $row[5] ?>' />
                                    <input type='hidden' name='shipping' value=' N<?php echo $row[4] ?>' />     
