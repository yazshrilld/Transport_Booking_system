...
<?php  include "header.php"; ?>
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <button class="btn btn-primary" id="hide">Round Trip</button>
      <button class="btn btn-info" id="show">One Way</button>
      <button class="btn btn-warning" id="sow">Multi Trip</button>
      </div>
      <!-- div 1 -->
		  <div id="roundTrip" class="booking-form">
      ...
      <button class="btn btn-danger" type="submit" name="quickBook">Quick Book</button>
    ...
    <!-- div 2 -->
    <div id="oneWay" class="booking-form">
			<label>Travelling From</label>
			<select name="state_from" class="form-control origin">
				<option value="0">---Select State---</option>
				<?php 
    ...
    <!-- div 3 -->
    <div id="multiWay" class="booking-form">
			<label>Travelling From</label>
			<select name="state_from" class="form-control origin">
				<option value="0">---Select State---</option>
				<?php 
